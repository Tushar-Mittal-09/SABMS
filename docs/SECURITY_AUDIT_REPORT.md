...
| **Sprint 2.5**  | Canonical Email OTP               | 6-digit CSPRNG numeric OTP (`crypto.randomInt`), HMAC-SHA256 hashed in Redis, 5-min TTL, 60s cooldown, 5-attempt invalidation.                  | **PASSED**          |
